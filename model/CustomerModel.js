...
export function saveCustomer(customer, callback) {
    ...
    http.open("POST", "http://localhost:8080/PosBackend/customer", true);
...
export function getAllCustomers() {
    return new Promise((resolve, reject) => {
        ...
        http.open("GET", "http://localhost:8080/PosBackend/customer", true);
        http.send();
    });
}
...
export function updateCustomer(customer) {
    ...
    http.open("PUT", "http://localhost:8080/PosBackend/customer", true);
    http.setRequestHeader("Content-Type", "application/json");
    http.send(customerJSON);
}
...
export function deleteCustomer(customerId) {
    ...
    http.open(
        "DELETE",
        `http://localhost:8080/PosBackend/customer?custId=${customerId}`,
        true
);
    http.send();
}